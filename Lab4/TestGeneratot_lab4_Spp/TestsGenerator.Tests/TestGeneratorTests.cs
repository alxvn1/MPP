...
public class TestGeneratorTests
{
    ...
    public async Task GenerateTestsAsync_CreatesTestFiles_ForPublicClasses()
    {
        ...
        string tempInputDir = Path.Combine(Path.GetTempPath(), "Input_" + runId);
        string tempOutputDir = Path.Combine(Path.GetTempPath(), "Output_" + runId);
        ...
        try 
        {
            ...
            await generator.GenerateTestsAsync(new[] { inputFile }, tempOutputDir);
